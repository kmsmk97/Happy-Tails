...
%>
	...
	<!-- user inputs -->
		...
		Victory Log ID            : <input type = "text" name ="vlid"  value="<%=resultSet.getString("vlid") %>"  readonly><br><br>
	
	
		Coordinator Name      : 	<input type = "text" name ="cname"  value="<%=resultSet.getString("cname") %>"readonly><br><br>

		Program Type       : 		<input type = "text" name ="program"  value="<%=resultSet.getString("program") %>"><br><br>
	
	 	City Name  : 				<input type = "text" name ="city"  value="<%=resultSet.getString("city") %>"><br><br>
	
		Location           : 		<input type = "text" name ="location"  value="<%=resultSet.getString("location") %>"><br><br>
	
		Conducted Date             : <input type="date" name="date" id="dateWithMax" value="<%=resultSet.getString("date") %>"><br><br>
								      		<script>
												var today = new Date();
		...
		Budget (Rs.)           :	 <input type = "number" name ="budget"  value="<%=resultSet.getString("budget") %>"><br><br>
