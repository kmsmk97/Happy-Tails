	...
	<h1>Members Report</h1>
		...
		try {
			...
			statement = connection.createStatement();
				...
				String sql = "select *   from member where date like '"+month+"%'";
		...
		<%
				...
				String sql1 = "select COUNT(id) AS count from member where date like '"+month+"%' ";
				...
				%>
				<tr class="back">
				    <td><h4> Monthly total registered members</h4> </td>
...
<a href="reportsearch.jsp"  class="button button2">BACK</a> 
</center>
