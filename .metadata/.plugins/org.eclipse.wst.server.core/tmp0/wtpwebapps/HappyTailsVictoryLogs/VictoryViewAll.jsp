...
<h1>VICTORY LOGS</h1>
	<BR>
		...
		<table align="center">
			...
			<td><input type="date" name="date" id="dateWithMax" required>
      		<script>
				var today = new Date();
...
<br><br>
<b style="font-size:20px;">Generate All Victory Logs.Csv</b> <br><a href="VictoryReport"><button style= "background-color:#e60000; COLOR:WHITE;width:80px;height:30px" ><b>Download</b></button></a>
<br><br><br><br><br>
